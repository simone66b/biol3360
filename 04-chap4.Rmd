...
Data frames are lists. But they have a special property: All elements of the data frame (the list) are equal in length. Data frames are the usual way of presenting data for statistical analysis. They make sense: You measure some variables (which become the columns of the data frame) and you measure each variable a number of times (the observations of each variable). Hence, data frames are rectangular. Although the length of each element (variable) in a 